...
SYMBOLIC_LIB = {'x': (lambda x: x, lambda x: x, 1, lambda x, y_th: ((), x)),
                 ...
                 '1/x^4': (lambda x: 1/x**4, lambda x: 1/x**4, 3, f_inv4),
                 '1/x^5': (lambda x: 1/x**5, lambda x: 1/x**5, 3, f_inv5),
                 'sqrt': (lambda x: torch.sqrt(x), lambda x: sympy.sqrt(x), 3, f_sqrt),
                 'x^0.5': (lambda x: torch.sqrt(x), lambda x: sympy.sqrt(x), 3, f_sqrt),
                 ...
                 'abs': (lambda x: torch.abs(x), lambda x: sympy.Abs(x), 5, lambda x, y_th: ((), torch.abs(x))),
                 ...
                 'tan': (lambda x: torch.tan(x), lambda x: sympy.tan(x), 4, f_tan),
                 'tanh': (lambda x: torch.tanh(x), lambda x: sympy.tanh(x), 5, lambda x, y_th: ((), torch.tanh(x))),
                 'sgn': (lambda x: torch.sign(x), lambda x: sympy.sign(x), 5, lambda x, y_th: ((), torch.sign(x))),
                 ...
                 '0': (lambda x: x*0, lambda x: x*0, 99, lambda x, y_th: ((), x*0)),
